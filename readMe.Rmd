...
ggplot(data=commute, aes(x=mpg,   y=duration))+geom_point()+facet_grid(.~destination)+scale_size_continuous(range = c(3,10))
ggplot(data=commute, aes(x=mpg,   y=duration, color=destination))+geom_point(alpha=.5)+scale_size_continuous(range = c(3,10))
```
